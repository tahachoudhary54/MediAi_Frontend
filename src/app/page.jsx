          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex gap-4">
                {["Twitter", "LinkedIn", "GitHub", "Facebook"].map((network, i) => (
                  <div key={i} className="h-8 w-8 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-500 hover:text-teal-400 hover:border-teal-500/30 hover:scale-115 transition-all duration-300 cursor-pointer font-bold text-[10px]">
                    {network[0]}
                  </div>
                ))}
              </div>
